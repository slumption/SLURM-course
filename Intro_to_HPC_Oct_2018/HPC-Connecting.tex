...
\item{Exercise 3: Unzip the excercises.tar file}
\item{Excecise 4: Navigating the command line}
\item{Excecise 5: Learn more about a command}
\end{itemize}
\end{frame}
...
\visible<4->{\begin{description}
\item[\emph{Hints:}]{Do \alert{mv exercises myexercises}}
\end{description}}
\end{itemize}
\end{frame}
